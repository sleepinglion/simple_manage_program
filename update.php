...
try {
    ...
    $stmt_insert=$pdo->prepare('UPDATE requests SET area_name=:area_name,school_name=:school_name,student=:student,address=:address,manager=:manager,phone=:phone,email=:email,date=:date,vehicle=:vehicle,comments=:comments WHERE id=:id');
