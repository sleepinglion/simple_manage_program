...
try {
    ...
    $stmt_insert=$pdo->prepare('INSERT INTO check_date(area_name,school_name,student,address,manager,phone,email,date,vehicle,comments,reg_time) VALUES(:area_name,:school_name,:student,:address,:manager,:phone,:email,:date,:vehicle,:comments,:reg_time)');
...
<script>
alert ("접수되었습니다");
location.href='http://waglewagle.org/theme/jewelry/skin/content/textbook/textbook_form.php';
</script>
